  ...
  return (
    <div className="space-y-1.5">
      ...
      <input
        ...
        min={min}
        max={max}
        className={`w-full text-sm px-4 py-2.5 rounded-xl border-2 transition-all focus:outline-none focus:ring-2 focus:ring-blue-100 ${
          error
    ...
    <div className="space-y-1.5">
      ...
      <div className="relative">
        <select
          value={value || ""}
          onChange={(e) => onChange?.(e.target.value)}
          className={`w-full text-sm px-4 py-2.5 rounded-xl border-2 transition-all focus:outline-none focus:ring-2 focus:ring-blue-100 appearance-none ${
            error
              ? "border-red-300 bg-red-50 focus:border-red-400"
              : "border-gray-200 bg-white focus:border-blue-400"
          } text-gray-700`}
